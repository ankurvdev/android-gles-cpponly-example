...
static int engine_init_display(struct engine* engine)
{
    ...
    for (; i < numConfigs; i++)
    {
        ...
        if (eglGetConfigAttrib(display, cfg, EGL_RED_SIZE, &r) && eglGetConfigAttrib(display, cfg, EGL_GREEN_SIZE, &g)
            && eglGetConfigAttrib(display, cfg, EGL_BLUE_SIZE, &b) && eglGetConfigAttrib(display, cfg, EGL_DEPTH_SIZE, &d) && r == 8
            && g == 8 && b == 8 && d == 0)
        {
    ...
    engine->renderer    = new SimpleRenderer();
